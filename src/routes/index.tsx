...
function Hero({ onOpenWaitlist }: { onOpenWaitlist: () => void }) {
  return (
    <section className="relative overflow-hidden border-b-2 border-foreground">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-20 md:pt-8 pb-14 grid md:grid-cols-2 gap-12 items-center">
        <div>
...
function HowItWorks() {
  const steps = [
    { n: "01", title: "Drop it in", body: "Share from outside the app, paste a link, or upload a photo, video, or block of text." },
